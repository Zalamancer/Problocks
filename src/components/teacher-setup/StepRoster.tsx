...
function GoogleClassroomConnect({
  ...
  // Pick a course: link it to the Playdemy class being set up. The roster
  // itself is imported server-side at /api/classes POST time (see
  // importClassroomRoster) using the classroom.rosters.readonly scope —
  // here we just capture the linkage + show a preview on the right.
