    ...
    <div className="pbs-wrap" style={{ padding: 0, maxWidth: 1240, margin: '0 auto' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
          ...
          <a href="#help" style={{ fontSize: 13.5, fontWeight: 500, padding: '7px 12px', color: 'var(--pbs-ink)', whiteSpace: 'nowrap', borderRadius: 999, border: '1.5px solid var(--pbs-line-2)' }}>Need help?</a>
        </div>
      </div>
    </div>
  </nav>
