// AP Physics FRQ content — original text modeled on the AP style.
...
export const FRQ_CART_ON_INCLINE: FRQ = {
  source: {
    exam: 'AP Physics 1',
    year: 2022,
    frq: 'FRQ #2',
      ...
      micros: [
        {
          ...
          explain:
            'Only the component of gravity along the ramp accelerates the cart: F∥ = mg sin θ.',
        },
        {
          id: 'a2',
          kind: 'choice',
          ...
          explain:
            'Divide F∥ by m: a = g sin θ. No friction, so nothing subtracts from it.',
        },
        {
          id: 'a3',
          kind: 'choice',
      ...
      micros: [
        {
          ...
          explain:
            'Squaring gives t² = 2L / (g sin θ), i.e. t² is proportional to 1/sin θ.',
        },
        {
          id: 'b2',
          kind: 'choice',
          ...
          explain:
            't² = (2L/g)(1/sin θ). Plotting t² against 1/sin θ gives slope 2L/g, intercept 0.',
        },
      ],
    },
    {
      ...
      micros: [
        ...
        },
        {
          ...
          explain:
            'g = 2L / slope = 2(1.50) / 0.30 = 10 m/s². Within ~2% of accepted 9.8.',
        },
      ],
    },
    {
      ...
      micros: [
        {
          ...
          explain:
            'F = ma and F = mg sin θ, so m cancels: a = g sin θ, independent of mass.',
        },
        {
          id: 'd2',
          kind: 'choice',
          ...
          explain:
            "Since a doesn't depend on m, the times t for a given θ are also independent of mass.",
        },
      ],
    },
    {
      ...
      micros: [
        {
          ...
          explain:
            'Friction points up the ramp, reducing net force → a_measured < g sin θ.',
        },
        {
          id: 'e2',
          kind: 'choice',
          ...
          explain:
            'Slope = 2L/g. Larger slope ⇒ smaller g. The experiment underestimates g.',
        },
      ],
    },
    {
