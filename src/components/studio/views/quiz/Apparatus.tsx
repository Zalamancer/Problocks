...
// Schematic SVG of the cart-on-incline apparatus. Ported from the
// design bundle's apparatus.jsx, with color tokens remapped to --pb-*.

export function ApparatusViz({
  theta = 20,
  compact = false,
}: {
  theta?: number;
